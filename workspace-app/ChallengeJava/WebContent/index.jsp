...
<tr><td>Número de Documento: </td><td><input type="text" name="documento" onkeypress="return isNumberKey(event)" value="${alumno.persona.nroDoc}" ></td></tr>
...
<tr><td>Dirección: </td><td><input type="text" name="direccion" onkeypress="return isAlphaKey(event)" value="${alumno.persona.direccion}"></td></tr>
...
<tr><td>Número de Documento: </td><td><label>${alumno.persona.nroDoc}</label></td></tr>
...
<div id="showRecord" class="showForm">
	<table>
		<tr><td width="10%">Tipo Doc</td><td width="10%">Documento</td><td width="10%">Nombre</td><td width="10%">Apellido</td><td width="15%">Fecha Nacimiento</td><td width="15">Dirección</td><td width="10%">Legajo</td><td width="10%">Editar</td><td width="10%">Inscribir</td></tr>
		<%
